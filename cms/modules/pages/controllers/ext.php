...
class PagesController_Ext Extends Controller_Base
{
    ...
    public function editor()
    {
        ...
        $plugins = $this->config->plugins_ext;

        $template->plugins = Config::__("pages")->plugins_ext;

        $template->render("ext_editor");
    }
    ...
    public function save()
    {
        ...
        if($page)
        {
            ...
            $plugins = array();
            foreach(Config::__("pages")->plugins_ext as $plugin)
            {
