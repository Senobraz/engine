    ...
    tbar:
    {
        ...
        [
            ...
            /*{
                ...
                {
                    App.showEditor({
                        url: '/ajax/ext/modmanager.ext.config?module=<?php echo $args->module ?>',
            ...
            },*/
            {
                ...
                {
                    App.showEditor({
                        url: '/ajax/ext/filemanager.ext.editor',
                        id : 'filemanager',
        ...
        <?php if($args->top) echo 'render'; else echo 'expand' ?> : function(panel,anim)
        {
            if(panel.firstexp != true)
            {
                var tree = new Ext.tree.TreePanel({
                    ...
                    border: false,
                    rootVisible: false,
                    dataUrl: '/ajax/ext/pages.ext.treepages',
                    ...
                    listeners :
                    {
                        ...
                        {
                            App.showEditor({
                                url: '/ajax/ext/pages.ext.editor?id='+node.id,
                        ...
                        beforemovenode: function(tree, node, oldParent, newParent, index)
                        {
                            if(confirm('Сохранить измененый порядок?'))
                            {
                                Ext.Ajax.request(
                                    {
                                        url : '/ajax/ext/pages.ext.reorder',
                                        method: 'POST',
                                        params:
                                        {
                                            id: node.id,
