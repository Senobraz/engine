            ...
            <?php if($table_id) { ?>
                {
                    ...
                    tbar:
                    {
                        ...
                        [
                            ...
                            ,{
                                ...
                                {
                                    Ext.Ajax.request({
                                        url : '/ajax/ext/catalog.ext.import_form',
                                        method: 'POST',
                                        params:
                                        {
                                            section_id: <?php echo $section->id ?>,
                    ...
                    listeners:
                    {
                        render: function()
                        {
                                                    ...
                                                    [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            handler: function(btn)
                                                            {
                                                                ...
                                                                if(new_id == 0){
                                                                    Ext.Ajax.request({
                                                                        url : '/ajax/ext/catalog.ext.new_position',
                                                                        method: 'POST',
                                                                        params:{
                                                                ...
                                                                function images_form(){
                                                                    ...
                                                                    Ext.Ajax.request({
                                                                        url : '/ajax/ext/catalog.ext.images_form',
                                                                        method: 'POST',
                                                                        params:
                                                                        {
                                                                        ...
                                                                        success : function (response) {
                                                                            ...
                                                                            win.addListener('close',function(cmp){
                                                                                ...
                                                                                Ext.Ajax.request(
                                                                                    {
                                                                                        url : '/ajax/ext/catalog.ext.getimages',
                                                                                        method: 'POST',
                                                                                        params:
                                                                                        {
                                                                                            id: '<?php echo $section->id?>/position/<?php echo $name?>/'+form.getForm().findField('id').getValue()
                                                    ...
                                                    ,{
                                                        ...
                                                        [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                {
                                                                    Ext.Ajax.request({
                                                                        url : '/ajax/ext/catalog.ext.get_rel',
                                                                        method: 'POST',
                                                                        params:
                                                                        {
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                handler: function(btn)
                                                                {
                                                                    ...
                                                                    Ext.Ajax.request({
                                                                        url : '/ajax/ext/catalog.ext.rel_form',
                                                                        method: 'POST',
                                                                        params:
                                                                        {
                                                                            title : '<?=$field['title']?>',
                            ...
                            ({
                                url: '/ajax/ext/catalog.ext.position_records',
                                baseParams:
                                {
                        ...
                        [
                            {
                                ...
                                {
                                    Ext.Ajax.request({
                                        url : '/ajax/ext/catalog.ext.edit_section_form',
                                        method: 'POST',
                                        params:
                                        {
