...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="cms/modules/ext/html/css/application.css" />
        <style type="text/css">
            html, body {
                margin:0;
                padding:0;
    ...
    <body scroll="no" id="docs">
        ...
        <link rel="stylesheet" type="text/css" href="cms/modules/ext/html/css/chooser.css" />
        ...
        <script type="text/javascript" src="cms/modules/ext/html/js/application.js"></script>

        <div id="header">
            <h1><?php echo Config::__("ext")->title?> v.<?php mod("ext.version")?> - <?php echo htmlspecialchars(Registry::__instance()->site_name) ?></h1>
