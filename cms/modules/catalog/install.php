...
class CatalogInstall extends Install_Base {
	...
	public $sql = "CREATE TABLE IF NOT EXISTS `catalog_section` (
...
CREATE TABLE IF NOT EXISTS `position_forms` (
  ...
  `valid_phone` smallint(6) DEFAULT '0',
  `valid_name` smallint(6) DEFAULT '0',
...
";
	public $config = '<?xml version="1.0" encoding="UTF-8"?>
<config>
    <params>
        <param type="array">
        ...
        <param type="array">
            ...
            <items>
				...
				<item name="valid_phone" type="array">
                    <value name="field">valid_phone</value>
                    <value name="title">Проверка на Телефон</value>
                    <value name="type">check</value>
                    <value name="mode">edit</value>
                </item>
                <item name="valid_name" type="array">
                    <value name="field">valid_name</value>
                    <value name="title">Проверка на Имя</value>
                    <value name="type">check</value>
                    <value name="mode">edit</value>
                </item>
